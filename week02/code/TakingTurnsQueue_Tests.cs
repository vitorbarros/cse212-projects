...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: 1) PersonQueue was using Insert(0, person) instead of Add(person), causing LIFO instead of FIFO behavior. 2) GetNextPerson was re-enqueuing people even when their turns reached 0, causing infinite loops. 
    ...
    // Defect(s) Found: Same defects as above - PersonQueue LIFO behavior and incorrect re-enqueuing logic. 
